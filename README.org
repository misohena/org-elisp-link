...
There is a function to complete the <path> part and description part of the link with completion-at-point (M-TAB or C-M-i).
...
(with-eval-after-load "org"
  ...
  (dolist (type '("file" "file+sys" "file+emacs"))
          (org-link-set-parameters
           ...
           :capf-desc 'org-elisp-link-capf-desc-file))
  )
#+end_src
